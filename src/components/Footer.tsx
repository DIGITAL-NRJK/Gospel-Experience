...
export default function Footer() {
  return (
    <footer className="bg-[var(--color-cream)]">
      <div className="grid grid-cols-[1.5fr_1fr_1fr_1fr] gap-7 px-7 pt-9 pb-5 border-t border-[rgba(43,27,94,0.06)]">
        <div>
      ...
      <div className="flex justify-between px-7 py-3 border-t border-[rgba(43,27,94,0.04)] text-[10px] text-[var(--color-text-light)]">
